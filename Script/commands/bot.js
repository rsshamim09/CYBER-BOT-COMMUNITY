...
  if ((event.body.toLowerCase() == "shamim") || (event.body.toLowerCase() == "Shamim vai") || (event.body.toLowerCase() == "@SH A MI M") || (event.body.toLowerCase() == "শামীম")) {
     return api.sendMessage("আমার জান এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",threadID);

       
   };

   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "ceo")) {
     return api.sendMessage("[𝐎𝐖𝐍𝐄𝐑:☞ SH A MI M ☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 ullash.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝 :- https://www.facebook.com/share/1BU7Z2zF7t/\nতার সাতে যোগা যোগ করবেন WhatsApp :- +01876582***", threadID);
   };

   if ((event.body.toLowerCase() == "tor jamai ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("আমার জামাই শামীম..!🥹🫶", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is SH A MI M❤️ তাকে সবাই শামীম নামে  চিনে🤙", threadID);
   };
...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami shamim") || (event.body.toLowerCase() == "cup sala ami shamim") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Aunkon Das") || (event.body.toLowerCase() == "@Aunkon Das ")) {
     return api.sendMessage("খবরদার কেউ এই আইড়ি মেনশন দিবানা এটা আমার জান শামীম এর বন্ধুর  এর আইড়ি😠🥰⛏️", threadID);
   };
...
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার জান শামীম এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
...
  if ((event.body.toLowerCase() == "@MD Siam Talukdar ") || (event.body.toLowerCase() == "সিয়াম")) {
...
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে গার্লফ্রেন্ড টা দিয়ে দে আমার জান শামীম কে..!🌚⛏️🌶️", threadID);
   };
